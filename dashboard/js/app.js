...
(function () {
    ...
    function renderFixes() {
        ...
        if (noOwner.length > 0) {
            fixes.push({
                severity: 'high',
                icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>',
        ...
        if (lowQuality.length > 0) {
            fixes.push({
                severity: 'low',
                icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="4"></circle></svg>',
        ...
        if (noTier.length > 0) {
            fixes.push({
                severity: 'low',
                icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>',
        ...
        if (fixes.length === 0) {
            list.innerHTML = '<div class="fix-item"><div class="fix-icon low"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg></div><div class="fix-text"><strong>All clear!</strong><p>No urgent governance gaps found.</p></div></div>';
            return;
        }
